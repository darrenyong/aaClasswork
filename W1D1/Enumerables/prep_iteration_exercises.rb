...
def subwords(word, dictionary)
  ...
  substring_arr.select { |ele| dictionary.include?(ele) }
end
...
class Array
  ...
  def my_inject(&blk)
    dup_arr = self.dup
    accumulator = dup_arr.shift

    dup_arr.my_each do |ele|
...
def concatenate(strings)
  strings.inject { |accumulator, ele| accumulator + ele }
end